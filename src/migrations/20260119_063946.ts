...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_skills_category" AS ENUM('frontend', 'backend', 'devops', 'ai', 'other');
  ...
  CREATE TABLE "about" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"hero_headline" varchar DEFAULT 'Hi, I’m Hasnain Tanoli' NOT NULL,
  	"hero_subtext" varchar DEFAULT 'I build beautiful web experiences.' NOT NULL,
  	"email" varchar DEFAULT 'hello@hasnain.me' NOT NULL,
  	"location" varchar DEFAULT 'Dubai, UAE' NOT NULL,
  	"bio" jsonb,
